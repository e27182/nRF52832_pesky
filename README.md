...
Polish adapted version of Motion Driver 6.12 example
Add BLE stack (SoftDevice 132) to all examples
Adapt some simple HID device example
Create BLE HID joystick example with data from mpu9250
Add altimeter data
